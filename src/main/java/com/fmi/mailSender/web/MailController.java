...
public class MailController {
	...
	@GetMapping(path = "/history", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<EmailRecord>> fetchHistory() {
		return new ResponseEntity<>(mailService.fetchHistory(), HttpStatus.OK);
	}
}
